...
class Object(MaterialGraphicClip):
	...
	def Serialize(CSerializer,ifstream,jdVersion,sizeOf=True):
		...
		Data['__class'] = "MaterialGraphicUVTranslationClip"
		Data['CurveU'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)
		Data['CurveV'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)

...
class Object(MaterialGraphicClip):
	...
	def Serialize(CSerializer,ifstream,jdVersion,sizeOf=True):
		...
		Data['__class'] = "MaterialGraphicUVScaleClip"
		Data['CurveScaleU'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)
		Data['CurveScaleV'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)

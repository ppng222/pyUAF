...
class Object(MaterialGraphicClip):
	...
	def Serialize(CSerializer,ifstream,jdVersion,sizeOf=True):
		...
		Data['__class'] = "MaterialGraphicDiffuseColorClip"
		Data['CurveR'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)
		Data['CurveG'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)
		Data['CurveB'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)

...
class Object(MaterialGraphicClip):
	...
	def Serialize(CSerializer,ifstream,jdVersion,sizeOf=True):
		...
		Data['__class'] = "MaterialGraphicUVScrollClip"
		Data['CurveScrollU'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)
		Data['CurveScrollV'] = BezierCurveFloat.Serialize(CSerializer,ifstream,jdVersion,sizeOf)
